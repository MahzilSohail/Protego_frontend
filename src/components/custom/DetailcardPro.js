...
const Detailcard = () => {
  ...
  const product = pro.find((p) => p.id == productId);
...
//             PROTEGO - Protection on the go
//           </span>
//           <p className="text-2xl leading-relaxed mb-1 sm:mb-2">Pro-Model Blue</p>
//           <span className="text-[20px] leading-relaxed block mb-4 sm:mb-6">Rs. 18,000</span>
...
//                   key={size}
//                   onClick={() => setSelectedSize(size)}
//                   className={`w-12 h-12 border flex items-center justify-center text-sm ${selectedSize === size ? "border-black" : "border-gray-300 text-gray-500"
//                     }`}
//                 >
//                   {size}
//                 </button>
