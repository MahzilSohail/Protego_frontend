...
const Detailcard = () => {
  ...
  const product = std.find((p) => p.id == productId);
...
// "use client";
// import React, { useState } from "react";
// import ProtegoTabs from "./Descriptionstd";
// import { useCart } from "@/context/CartContext";
// import ProductGallery from "./Sliderstd";
...
//             PROTEGO - Protection on the go
//           </span>
//           <p className="text-2xl leading-relaxed mb-1 sm:mb-2">Student-Model Blue</p>
//           <span className="text-[20px] leading-relaxed block mb-4 sm:mb-6">Rs. 10,000</span>
